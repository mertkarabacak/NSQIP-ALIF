...
data = load_dataset("mertkarabacak/NSQIP-ALIF", data_files="alif_imputed.csv", use_auth_token = HF_TOKEN)
...
y1_xgb_params = {'objective': 'binary:logistic', 'booster': 'gbtree', 'lambda': 0.00018321062681370817, 'alpha': 0.00017089368937439682, 'max_depth': 9, 'eta': 0.2102676937904615, 'gamma': 9.188852707143112e-08, 'grow_policy': 'depthwise'}
y2_xgb_params = {'objective': 'binary:logistic', 'booster': 'gbtree', 'lambda': 7.943467696101444e-05, 'alpha': 0.0013053773773088716, 'max_depth': 2, 'eta': 0.38247757768511054, 'gamma': 0.0026206000583212543, 'grow_policy': 'lossguide'}
y3_xgb_params = {'objective': 'binary:logistic', 'booster': 'gbtree', 'lambda': 0.04512016796424231, 'alpha': 0.014538843998121128, 'max_depth': 9, 'eta': 0.9950927787698503, 'gamma': 1.7674735324956133e-08, 'grow_policy': 'depthwise'}

y1_lgb_params = {'objective': 'binary', 'boosting_type': 'gbdt', 'lambda_l1': 0.02924510763376101, 'lambda_l2': 5.849619508147393e-08, 'num_leaves': 227, 'feature_fraction': 0.768675449292327, 'bagging_fraction': 0.4945660263991546, 'bagging_freq': 3, 'min_child_samples': 28}
y2_lgb_params = {'objective': 'binary', 'boosting_type': 'gbdt', 'lambda_l1': 0.2421048924028371, 'lambda_l2': 7.609570852704783, 'num_leaves': 3, 'feature_fraction': 0.7274260283828627, 'bagging_fraction': 0.5241872300963137, 'bagging_freq': 2, 'min_child_samples': 90}
y3_lgb_params = {'objective': 'binary', 'boosting_type': 'gbdt', 'lambda_l1': 1.9761253774083124e-05, 'lambda_l2': 1.6287247549653548e-07, 'num_leaves': 191, 'feature_fraction': 0.7002743151401251, 'bagging_fraction': 0.8088413022690079, 'bagging_freq': 4, 'min_child_samples': 54}

y1_cb_params = {'objective': 'Logloss', 'colsample_bylevel': 0.05979969629909132, 'depth': 12, 'boosting_type': 'Plain', 'bootstrap_type': 'Bayesian', 'bagging_temperature': 3.1517077008153755}
y2_cb_params = {'objective': 'CrossEntropy', 'colsample_bylevel': 0.06698806119113387, 'depth': 7, 'boosting_type': 'Plain', 'bootstrap_type': 'Bernoulli', 'subsample': 0.14791856851244828}
y3_cb_params = {'objective': 'Logloss', 'colsample_bylevel': 0.09448659423867571, 'depth': 12, 'boosting_type': 'Plain', 'bootstrap_type': 'MVS'}

y1_rf_params = {'criterion': 'gini', 'max_features': 'auto', 'max_depth': 86, 'n_estimators': 700, 'min_samples_leaf': 2, 'min_samples_split': 5}
y2_rf_params = {'criterion': 'entropy', 'max_features': 'auto', 'max_depth': 3, 'n_estimators': 1600, 'min_samples_leaf': 4, 'min_samples_split': 6}
y3_rf_params = {'criterion': 'gini', 'max_features': 'log2', 'max_depth': 89, 'n_estimators': 1100, 'min_samples_leaf': 4, 'min_samples_split': 4}
...
with gr.Blocks(title="NSQIP-ALIF") as demo:
    ...
    gr.Markdown(
        """
    # Prediction Tool
    ## Short-Term Postoperative Outcomes Following Anterior Lumbar Interbody Fusion
    **The publication describing the details of this predictive tool will be posted here upon the acceptance of publication.**
    ...
    with gr.Tab('Length of Stay'):
        ...
        ### Prolonged Length of Stay Prediction Model for Anterior Lumbar Interbody Fusion
        """
        )
    ...
    with gr.Tab('Non-home Discharge'):
        ...
        ### Non-home Discharge Prediction Model for Anterior Lumbar Interbody Fusion
        """
        )
    ...
    with gr.Tab('Readmission'):
        ...
        ### Readmission Prediction Model for Anterior Lumbar Interbody Fusion      
        """
        )
